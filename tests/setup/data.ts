...
export const KEYWORD_RULES: Array<{
  ...
  // Campos de Cultivo
  { pattern: /\bnombre\s+de\s+la\s+variedad/i, action: { type: 'REPLY', reply: '{variety_name}' }, note: 'Pide variedad (usado en: createCrop, createPlannedCampaign, createPlannedWork)', priority: 4 },
  { pattern: /\bvariedad(\s+del\s+cultivo)?[\s]*[?:]/i, action: { type: 'REPLY', reply: '{variety_name}' }, note: 'Pide variedad (usado en: createCrop, createPlannedCampaign, createPlannedWork)', priority: 4 },
  { pattern: /\bnombre\s+del\s+cultivo/i, action: { type: 'REPLY', reply: '{crop_name}' }, note: 'Pide nombre cultivo (usado en: createCrop, createPlannedCampaign, createPlannedWork)', priority: 4 },
  { pattern: /\bqu[ée]\s+cultivo/i, action: { type: 'REPLY', reply: '{crop_name}' }, note: 'Pide qué cultivo (usado en: createCrop, createPlannedCampaign, createPlannedWork)', priority: 4 },
  { pattern: /\bdestino(\s+del\s+cultivo)?/i, action: { type: 'REPLY', reply: '{destination}' }, note: 'Pide destino (usado en: createCrop)', priority: 4 },
  { pattern: /\bmarca(\s+del\s+cultivo)?/i, action: { type: 'REPLY', reply: '{brand}' }, note: 'Pide marca (usado en: createCrop, createChemicalProduct)', priority: 4 },
  ...
  { pattern: /\bprincipio\s+activo/i, action: { type: 'REPLY', reply: '{active_matter_name}' }, note: 'Pide principio activo (usado en: getActiveMatterChemicalProducts)', priority: 4 },
  { pattern: /\bplaga\s+objetivo/i, action: { type: 'REPLY', reply: '{target_pest}' }, note: 'Pide plaga objetivo (usado en: createChemicalProduct)', priority: 4 },
  { pattern: /\bplaga/i, action: { type: 'REPLY', reply: '{target_pest}' }, note: 'Pide plaga (usado en: createChemicalProduct)', priority: 4 },
  { pattern: /\bmodo\s+de\s+acci[oó]n/i, action: { type: 'REPLY', reply: '{mode_of_action}' }, note: 'Pide modo acción (usado en: createChemicalProduct)', priority: 4 },
  
  // Campos de Granja/Campo
  { pattern: /\bnombre\s+de\s+la\s+granja/i, action: { type: 'REPLY', reply: '{farm_name}' }, note: 'Pide granja (usado en: createPlannedCampaign, createPlannedWork, reportFinishedWork)', priority: 4 },
  { pattern: /\bgranja/i, action: { type: 'REPLY', reply: '{farm_name}' }, note: 'Pide granja (usado en: createPlannedCampaign, createPlannedWork, reportFinishedWork)', priority: 4 },
  { pattern: /\bexplotaci[oó]n/i, action: { type: 'REPLY', reply: '{farm_name}' }, note: 'Pide explotación (usado en: createPlannedCampaign, createPlannedWork, reportFinishedWork)', priority: 4 },
  { pattern: /\bqu[ée]\s+granja/i, action: { type: 'REPLY', reply: '{farm_name}' }, note: 'Pide qué granja (usado en: createPlannedCampaign, createPlannedWork, reportFinishedWork)', priority: 4 },
  { pattern: /\bnombre\s+del\s+campo/i, action: { type: 'REPLY', reply: '{field_name}' }, note: 'Pide campo (usado en: createPlannedCampaign, createPlannedWork, reportFinishedWork)', priority: 4 },
  { pattern: /\bcampo/i, action: { type: 'REPLY', reply: '{field_name}' }, note: 'Pide campo (usado en: createPlannedCampaign, createPlannedWork, reportFinishedWork)', priority: 4 },
  { pattern: /\bparcela/i, action: { type: 'REPLY', reply: '{field_name}' }, note: 'Pide parcela (usado en: createPlannedCampaign, createPlannedWork, reportFinishedWork)', priority: 4 },
  { pattern: /\bqu[ée]\s+campo/i, action: { type: 'REPLY', reply: '{field_name}' }, note: 'Pide qué campo (usado en: createPlannedCampaign, createPlannedWork, reportFinishedWork)', priority: 4 },
  
  // Campos de Trabajo
  { pattern: /\btipo\s+de\s+trabajo/i, action: { type: 'REPLY', reply: '{type_work}' }, note: 'Pide tipo trabajo (usado en: createPlannedWork, reportFinishedWork)', priority: 4 },
  { pattern: /\bID\s+del\s+trabajo/i, action: { type: 'REPLY', reply: '{work_id}' }, note: 'Pide ID trabajo (usado en: reportFinishedWork)', priority: 4 },
  { pattern: /\bhoras\s+trabajadas/i, action: { type: 'REPLY', reply: '{worked_hours}' }, note: 'Pide horas (usado en: reportFinishedWork)', priority: 4 },
  { pattern: /\bdosis\s+aplicada/i, action: { type: 'REPLY', reply: '{applied_dose}' }, note: 'Pide dosis aplicada (usado en: reportFinishedWork)', priority: 4 },
  { pattern: /\bdosis\s+general/i, action: { type: 'REPLY', reply: '{general_dose}' }, note: 'Pide dosis general (usado en: createPlannedWork)', priority: 4 },
  { pattern: /\bcantidad\s+cosechada/i, action: { type: 'REPLY', reply: '{amount_harvested}' }, note: 'Pide cantidad cosechada (usado en: reportFinishedWork)', priority: 4 },
  { pattern: /Profundidad/i, action: { type: 'REPLY', reply: '{depth}' }, note: 'Pide profundidad (usado en: createPlannedWork, reportFinishedWork)', priority: 4 },
  { pattern: /Combustible usado/i, action: { type: 'REPLY', reply: '{fuel_used}' }, note: 'Pide combustible (usado en: reportFinishedWork)', priority: 4 },
  
  // Campos de Precio
  { pattern: /Precio/i, action: { type: 'REPLY', reply: '{price}' }, note: 'Pide precio (usado en: assignPriceProduct, createChemicalProduct, getMinPrice, getLastPrice, getPriceVariation)', priority: 4 },
  { pattern: /Fecha del precio/i, action: { type: 'REPLY', reply: '{price_date}' }, note: 'Pide fecha precio (usado en: assignPriceProduct)', priority: 4 },
  { pattern: /Nombre del producto/i, action: { type: 'REPLY', reply: '{product_name}' }, note: 'Pide nombre producto (usado en: assignPriceProduct, getMinPrice, getLastPrice, getPriceVariation, getSeedsNeeded)', priority: 4 },
  
  // Búsquedas
  { pattern: /Búsqueda/i, action: { type: 'REPLY', reply: '{search_query}' }, note: 'Pide búsqueda (usado en: searchProducts, searchProductsCrops, searchProductsFertilizers)', priority: 4 },
  { pattern: /Qué producto buscar/i, action: { type: 'REPLY', reply: '{search_query}' }, note: 'Pide producto búsqueda (usado en: searchProducts, searchProductsCrops, searchProductsFertilizers)', priority: 4 },
