...
export const VARS: Record<string, string> = {
  ...
  client_name: process.env.VAR_CLIENT_NAME || 'Héctor',
  ...
  farm_name: process.env.VAR_FARM_NAME || 'Chapardia',
  fertilizer_name: process.env.VAR_FERTILIZER_NAME || 'Nitrofoska',
  field_name: process.env.VAR_FIELD_NAME || '1',
  ...
  nombre_usuario_cliente: process.env.VAR_NOMBRE_USUARIO_CLIENTE || 'Laura',
  ...
  search_query: process.env.VAR_SEARCH_QUERY || 'trigo',
