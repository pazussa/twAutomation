...
for (const entry of data.conversation) {
  ...
  // Usar el resultado ya calculado en el JSON
  const isOK = entry.result === 'ok';
...
// No modificar el JSON, solo generar HTML
console.log(`\n📋 Generando HTML...`);
...
<head>
    ...
    <title>Ejecución ${data.executionId} - FINAL HUMUS</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🪱 Ejecución ${data.executionId} - FINAL HUMUS</h1>
            <p>Generado: ${new Date().toLocaleString('es-ES')}</p>
            <p style="opacity: 0.8; font-size: 0.9em;">Intents de precio: CEBADA | Fertilizantes: HUMUS DE LOMBRIZ</p>
            <div class="stats">
                <div class="stat">
...
const outputPath = `Ejecucion-${data.executionId}-FINAL-HUMUS.html`;
